...
1. Make a new folder. Call it my_new_dir.

2. Change directories to my_new_dir. Make a new file called my_new_file.txt.

3. Print your present working directory.

4. View the manual for the command  you just used.

5. Use VSCode (or your preferred text editor) to open your ~/.zshrc file. Set a new global environment variable called SQ_CC equal to "Blackjack". Close VSCode.

6. Open a new terminal and check that the environment variable SQ_CC is indeed "Blackjack".
